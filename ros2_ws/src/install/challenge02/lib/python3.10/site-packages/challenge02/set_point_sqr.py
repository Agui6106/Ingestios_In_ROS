...
Generates a Square signal for the controller
...
class SetPointPublisher(Node):
    def __init__(self):
        ...
        self.signal_publisher = self.create_publisher(Float32, 'set_point_sqr', 10)    ## CHECK FOR THE NAME OF THE TOPIC
        ...
        self.get_logger().info("SetPoint Square Node Started \U0001F680")
