...
"""
Genera un launch file que activa otros launch files, apra ahorrar tiempo

Note que se requieren los launch separados segun los grupos que deseamos crear

Es decir todo este laucnh abre un nuevo archivo agrupando nodos de todo mi pauqete,
asiggnandoles nombres a los grupos apra poder tener control sobre todos los demas
"""
...
def generate_launch_description():
    ...
    #Get the address of the package share directory
    ...
    # (le decimos que eso es lo que queremos que ejecuten como fuente para cada grupo)
    ...
    # Agregamos el launch file a la descripcion del launch de cadagrupo
